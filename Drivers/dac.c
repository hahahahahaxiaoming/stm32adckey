...
void Dac1_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE ); //使能 P A 时钟
	...
	DAC_SetChannel1Data(DAC_Align_12b_R, 0); // 位右对齐 设置 DAC 初始 值
}
//设置通道 1 输出电压
...
void Dac1_Set_Vol(u16 vol)
{
	...
	temp/=1000;
	temp=temp*4096/3.3;
	DAC_SetChannel1Data(DAC_Align_12b_R,temp); //12位右对齐 设置 DAC 值
}
